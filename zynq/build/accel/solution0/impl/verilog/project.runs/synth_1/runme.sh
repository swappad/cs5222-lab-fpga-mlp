...
HD_PWD='/home/krueger/cs5222/projects/project2/cs5222-lab-fpga-mlp/zynq/build/accel/solution0/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmult_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmult_hw.tcl

...
#ifndef __mmult_hw_mac_mulaitb__HH__
#define __mmult_hw_mac_mulaitb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mac_mulaitb) {
    ...
    SC_CTOR(mmult_hw_mac_mulaitb):  simcore_mac_0_U ("simcore_mac_0_U") {

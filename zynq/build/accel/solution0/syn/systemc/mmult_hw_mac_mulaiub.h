...
#ifndef __mmult_hw_mac_mulaiub__HH__
#define __mmult_hw_mac_mulaiub__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mac_mulaiub) {
    ...
    SC_CTOR(mmult_hw_mac_mulaiub):  simcore_mac_0_U ("simcore_mac_0_U") {

...
#ifndef __mmult_hw_mac_mulaivb__HH__
#define __mmult_hw_mac_mulaivb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mac_mulaivb) {
    ...
    SC_CTOR(mmult_hw_mac_mulaivb):  simcore_mac_1_U ("simcore_mac_1_U") {

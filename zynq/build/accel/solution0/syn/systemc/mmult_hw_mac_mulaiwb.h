...
#ifndef __mmult_hw_mac_mulaiwb__HH__
#define __mmult_hw_mac_mulaiwb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mac_mulaiwb) {
    ...
    SC_CTOR(mmult_hw_mac_mulaiwb):  simcore_mac_2_U ("simcore_mac_2_U") {

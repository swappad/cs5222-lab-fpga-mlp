...
#ifndef __mmult_hw_mul_8ns_isb__HH__
#define __mmult_hw_mul_8ns_isb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mul_8ns_isb) {
    ...
    SC_CTOR(mmult_hw_mul_8ns_isb):  ACMP_mul_us_U ("ACMP_mul_us_U") {

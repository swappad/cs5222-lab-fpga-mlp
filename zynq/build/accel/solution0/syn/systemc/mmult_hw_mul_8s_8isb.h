...
#ifndef __mmult_hw_mul_8s_8isb__HH__
#define __mmult_hw_mul_8s_8isb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mul_8s_8isb) {
    ...
    SC_CTOR(mmult_hw_mul_8s_8isb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
